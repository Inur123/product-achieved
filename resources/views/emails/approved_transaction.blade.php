...
<body>
    <div class="container">
        ...
        <div class="content">
            <p style="text-align: center; font-size: 18px; font-weight: bold; color: #374151;">
                @if ($transaction->status === 'completed' || $transaction->status === 'approved')
            ...
            <div class="next-steps">
                ...
                <ul>
                    @if ($transaction->status === 'completed' || $transaction->status === 'approved')
                        <li>Pesanan Anda telah selesai diproses.</li>
                        <li>Terima kasih telah berbelanja bersama kami.</li>
                        <li>Silakan memberikan ulasan untuk produk yang Anda beli.</li>
                    @else
