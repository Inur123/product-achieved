    ...
    <div class="lg:col-span-2 space-y-8">
                        ...
                        @if($promotions->isNotEmpty())
                            ...
                            @foreach($promotions as $promotion)
                                @if($promotion->product_id == $product->id && $promotion->end_date >= \Carbon\Carbon::now())
                                    ...
                                    @endphp
                                    <span class="text-gray-500 line-through">Rp. {{ number_format($product->harga, 0, ',', '.') }}</span>
                ...
                <div class="space-y-4">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="name" placeholder="Enter your full name" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary" required>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Email Address</label>
                            <input type="email" name="email" placeholder="Enter your email address" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary" required>
                        </div>
                    </div>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">WhatsApp Number</label>
                            <input type="tel" name="phone" placeholder="Enter your WhatsApp number" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary" required>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Proof of Payment</label>
                            <input type="file" name="proof_of_payment" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary" required>
                    ...
                    <div>
                        ...
                        <textarea name="address" placeholder="Enter your complete address" rows="3" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary" required></textarea>
                    </div>
     ...
     <div class="lg:col-span-1">
        <div class="bg-white p-6 rounded-lg shadow-sm">
            ...
            <button type="submit" form="checkout-form" class="w-full bg-primary text-white py-3 rounded-lg font-medium mt-6">
                Complete Purchase
            </button>
        ...
        <div class="bg-white p-6 rounded-lg shadow-sm mt-6">
            ...
            <div class="bg-blue-50 p-4 rounded-lg">
                <p class="text-gray-700 font-medium mb-2">Please transfer the exact amount to the following bank account:</p>
                <div class="space-y-2">
