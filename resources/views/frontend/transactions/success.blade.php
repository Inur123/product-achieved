...
<section class="py-12 bg-white pt-20">
    <div class="container mx-auto px-4">
        <div class="max-w-4xl mx-auto">
            <!-- Success Message -->
            <div class="bg-green-50 border-2 border-success rounded-xl p-6 mb-8 text-center">
                ...
                <h2 class="text-3xl font-bold text-success mb-2">Payment Successful</h2>
                <p class="text-gray-700 text-lg mb-4">Thank you for your payment. Your order is being processed.</p>
                ...
                <div class="mb-6">
                    ...
                    <div class="relative pt-1">
                        <div class="flex mb-2 items-center justify-between">
                            <div>
                                <span class="text-xs font-semibold inline-block py-1 px-2 uppercase rounded-full text-success bg-green-200">
                                    Completed
                                </span>
                            </div>
                        ...
                        <div class="overflow-hidden h-2 mb-4 text-xs flex rounded bg-green-200">
                            <div style="width: 100%" class="shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center bg-success animate-progress"></div>
                        </div>
                ...
                <div class="border-t border-gray-200 pt-6">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="text-right">
                            ...
                            <span class="text-green-500 text-sm font-semibold">{{ ucfirst($transaction->status) }}</span>
                        </div>
                    </div>
                </div>
            </div>
