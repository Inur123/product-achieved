        ...
        <div class="flex items-center justify-between">
            ...
            <nav class="hidden md:flex space-x-8">
                @if (Request::is('/'))
                    ...
                    <a href="#hero" class="text-dark hover:text-primary font-semibold">Home</a>
...
<div
    id="menu-overlay"
    class="menu-overlay fixed inset-0 bg-black bg-opacity-50 z-40"
></div>
...
<script>
    document.querySelectorAll('a[href^="#"]').forEach(anchor => {
        anchor.addEventListener('click', function (e) {
            ...
            if (target) {
                const headerOffset = document.querySelector('header').offsetHeight; // Mendapatkan tinggi header
                const targetPosition = target.getBoundingClientRect().top + window.pageYOffset - headerOffset - -5; // Menambahkan offset (20px)
