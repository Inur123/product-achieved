<footer class="bg-dark text-white pt-12 pb-4">
    <div class="container mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
                <div class="mb-4">
                    <img src="{{ asset('images/logo-white.png') }}" alt="Achieved">
                </div>
                ...
                <div class="mb-2 mt-6">
                    <div class="max-w-[200px] mb-[23px] relative left-[2px]">
                        <a href="https://blockchain.stem.org/3f718a84-dc87-4c83-8a89-3f63173df85d#acc.mQLR2TG9" class="hover:text-gray-100">
                            <img src="{{ asset('images/stem-neg.png') }}" class="w-full h-auto" />
                        </a>
                    </div>
                </div>
            </div>
