        ...
        <section class="bg-gradient-to-r from-primary to-secondary py-16 pt-24" >
            <div class="container mx-auto px-4">
                <div class="text-center text-white">
                    <h1 class="text-4xl md:text-5xl font-extrabold mb-4">Products in {{ $category->name }}</h1>
                    <p class="text-xl max-w-3xl mx-auto">
                        Browse our complete collection of educational e-books designed for young minds in the {{ $category->name }} category.
                    </p>
                </div>
            </div>
        </section>
